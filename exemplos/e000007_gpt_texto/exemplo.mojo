...
fn _parse_chave_par(var chave: String) -> List[Int]:
    var idx = -1
...
fn _aprender_merges_bpe(mut sequencia: List[Int], var max_merges: Int) -> List[String]:
...
fn _feature_ultimo_token(saida_transformer, var dim: Int) -> List[Float32]:
...
fn _feature_token(saida_transformer, var pos: Int, var dim: Int) -> List[Float32]:
    var out = List[Float32]()
...
def executar_exemplo():
    ...
    var lotes = conjuntos_pkg.carregar_lotes_gpt_supervisionado_diretorio(dir_dataset, 3, 96, 96)
