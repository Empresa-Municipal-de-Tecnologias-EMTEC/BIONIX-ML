...
fn _imprimir_preview_embedding(t, var max_linhas: Int = 2, var max_cols: Int = 6):
...
def executar_exemplo():
    ...
    var txt_data = dados_pkg.carregar_txt(caminho_dataset)
    if len(txt_data.texto_completo.strip()) == 0:
